...
const Product = () => {
  ...
  return (
    <section>
      {/* Main Image */}
      <div
        className="relative w-full md:w-[415px] md:h-[400px] md:rounded-xl overflow-hidden cursor-pointer"
...
//     <section>
//       {/* Main Image */}
//       <div className="relative w-full md:w-[415px] md:h-[400px] md:rounded-xl overflow-hidden">
//         {/* Spinner */}
//         {loading && (
//           <div className="absolute inset-0 flex items-center justify-center bg-white/70">
//             <div className="w-8 h-8 border-4 border-orange-500 border-t-transparent rounded-full animate-spin"></div>
